...
<table class="meta"><tr></tr>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Nombre de la persona'"/>
...
<table class="meta"><tr></tr>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Telefono'"/>
...
<div class="captioneddiv">
<h3>Informaciones sobre la identificación</h3>
<table class="meta"><tr></tr>
      <xsl:call-template name="tablerow">
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Nombre de la persona de contacto'"/>
...
<table class="meta"><tr></tr>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Lugar de entrega'"/>
      <xsl:with-param name="cvalue" select="./gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:address/gmd:CI_Address/gmd:deliveryPoint/gco:CharacterString"/>
      </xsl:call-template>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Ciudad'"/>
...
<tr>
<td></td><td class="meta-param" align="center">Norte<br/>
...
<tr>
<td class="meta-param" align="center">Oeste<br/>
...
<td></td>
<td class="meta-param" align="center">Este<br/>
...
<tr>
<td></td><td class="meta-param" align="center">Sur<br/>
...
<div class="captioneddiv">
<h3>Informaciones sobre la distribución</h3>
<table class="meta"><tr></tr>
...
<div class="captioneddiv">
<h3>Informaciones sobre la identificación (Dublin Core)</h3>
<table class="meta"><tr></tr>
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Título'"/>
      ...
      <xsl:call-template name="tablerow">
      <xsl:with-param name="cname" select="'Formato de presentación'"/>
...
<td class="meta-param">Resumen:</td><td class="meta-value"><xsl:apply-templates select="./dct:abstract"/></td>
</tr>
</xsl:if>
